...
<head>
    ...
    <style>
        ...
        .ap-identification {
            ...
            margin: 0;
            padding: 0;
            page-break-inside: avoid; /* Prevent breaking within the card */
        }

        .ap-identification-front, .ap-identification-back {
            width: 100%;
            height: 100%;
        ...
        .ap-identification-back {
            page-break-before: always; /* Force the back to appear on a new page */
            transform: rotate(180deg); /* Rotate the back ID upside down */
        }
    </style>
</head>
<body>
