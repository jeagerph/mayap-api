...
class StoreSmsCreditRequest extends Request
{
    ...
    public function messages()
    {
        return [
            ...
            'credit_date.required' => 'Date of SMS is required.',
            'credit_date.date' => 'Date of SMS must be a valid date (2020-01-01)',
            'credit_date.date_format' => 'Date of SMS must be a valid date (2020-01-01)',
