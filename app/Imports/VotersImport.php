...
class VotersImport implements ToCollection, WithHeadingRow
{
    ...
    //         $application_no = $row['application_no'] ?  $row['application_no'] : null; 
    //         $application_date = $row['application_date'] ?  $row['application_date'] : null; 
    //         $application_type = $row['application_type'] ? $row['application_type'] : null;
