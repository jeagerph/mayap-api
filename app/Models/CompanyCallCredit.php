...
use App\Observers\CompanyCallCreditObserver as Observer;

class CompanyCallCredit extends Model
{
    use Observer;
    ...
    public function toArray()
    {
        ...
        if(request()->has('admin-company-call-credits-related')):
            $arr['id'] = $this->id;
    ...
    public function toArrayAdminCompanyCallCreditsRelated()
    {
        return [
            'id' => $this->id,
            'code' => $this->code,
