...
class SummarySheet implements FromArray, WithTitle, WithEvents
{
    ...
    public function array(): array
    {
        ...
        foreach ($this->data['companyAccounts'] as $companyAccount):

            $row[] = [
                $companyAccount['encoder'],
                $companyAccount['beneficiary'] ?: '0',
                $companyAccount['assistance'] ?: '0',
                $companyAccount['patient'] ?: '0',
            ];

            $totalBeneficiary += $companyAccount['beneficiary'];
            $totalAssistance += $companyAccount['assistance'];
            $totalPatient += $companyAccount['patient'];
